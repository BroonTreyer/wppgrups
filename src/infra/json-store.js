...
const INITIAL_STATE = { destinations: [], publications: [], deliveryEvents: [], offers: [], queue: [], sources: [], seenProducts: [], affiliateLinks: [], affiliateRequests: [], affiliateStatus: null, alerts: [], operation: { running: false }, memberTracking: { groups: {}, joins: [] }, dailyClosings: {} };
