export const DEFAULT_NICHES = [
  ...
  { id: "market", name: "Mercado e utilidades", keywords: ["mercado", "alimento", "cafe", "creme de leite", "leite condensado", "arroz", "feijao", "azeite", "chocolate", "bebida", "cerveja", "limpeza", "detergente", "sabao", "amaciante", "desinfetante", "papel higienico", "racao", "utilidade"] , veto: ["racao para", "comedouro"] },
  { id: "health", name: "Saude e bem-estar", keywords: ["saude", "vitamina", "colageno", "farmacia", "termometro", "massageador", "medidor de pressao", "monitor de pressao", "pressao arterial", "antiescara", "colchao hospitalar", "cadeira de rodas", "andador", "muleta", "glicosimetro", "oximetro", "balanca", "ortopedico", "fisioterapia", "primeiros socorros", "higiene", "absorvente", "fralda geriatrica", "nebulizador", "escova de dente eletrica", "suplemento", "omega", "magnesio", "melatonina", "probiotico"] , veto: ["papel higienico"] },
